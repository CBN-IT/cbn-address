...
public class AhWarmup extends HttpServlet {
	...
	public static void readFromFile() throws IOException {
		...
		if (GetAdrese.json == null) {
			String fromFile = FileUtils.getFromFile("siruta/siruta_parsat.json");
			GetAdrese.json = GsonUtils.getGson().fromJson(fromFile, new TypeToken<ArrayList<LinkedHashMap<String, String>>>() {
			}.getType());
		}
		long end = System.nanoTime();
		double seconds = (double)(end - start)/ 1000000000.0;
		Log.d("Loaded json into memory "+seconds);
	}
